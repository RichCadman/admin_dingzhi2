...
<head>
    ...
    <title>素材火www.sucaihuo.com - Rickshaw图表</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="graph_rickshaw.html">Rickshaw</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="graph_rickshaw.html#"><i class="fa fa-bars"></i> </a>
...
<!-- Rickshaw -->
<script src="/Pub/admin/js/plugins/rickshaw/vendor/d3.v3.js"></script>
<script src="/Pub/admin/js/plugins/rickshaw/rickshaw.min.js"></script>
...
<!-- Rickshaw demo data -->
<script src="/Pub/admin/js/demo/rickshaw-demo.js"></script>
