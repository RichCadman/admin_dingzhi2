...
<head>
    ...
    <title>素材火www.sucaihuo.com - 聊天窗口</title>
    ...
    <link href="/Pub/admin/css/plugins/jsTree/style.min.css" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="chat_view.html">聊天窗口</a>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="col-md-9 ">
                                    <div class="chat-discussion">
                                        ...
                                        <div class="chat-message">
                                            <img class="message-avatar" src="/Pub/admin/img/a1.jpg" alt="">
                                            <div class="message">
                                        ...
                                        <div class="chat-message">
                                            <img class="message-avatar" src="/Pub/admin/img/a4.jpg" alt="">
                                            <div class="message">
                                        ...
                                        <div class="chat-message">
                                            <img class="message-avatar" src="/Pub/admin/img/a2.jpg" alt="">
                                            <div class="message">
                                        ...
                                        <div class="chat-message">
                                            <img class="message-avatar" src="/Pub/admin/img/a5.jpg" alt="">
                                            <div class="message">
                                                <a class="message-author" href="chat_view.html#"> 林依晨Ariel </a>
                                                <span class="message-date">  2015-02-02 - 11:12:36 </span>
                                                <span class="message-content">
                                        ...
                                        <div class="chat-message">
                                            <img class="message-avatar" src="/Pub/admin/img/a6.jpg" alt="">
                                            <div class="message">
                                                <a class="message-author" href="chat_view.html#"> 林依晨Ariel </a>
                                                <span class="message-date">  2015-02-02 11:12:36 </span>
                                                <span class="message-content">
                                ...
                                <div class="col-md-3">
                                    <div class="chat-users">
                                        ...
                                        <div class="users-list">
                                            <div class="chat-user">
                                                <img class="chat-avatar" src="/Pub/admin/img/a4.jpg" alt="">
                                                <div class="chat-user-name">
                                                    <a href="chat_view.html#">伤城Simple</a>
                                                </div>
                                            </div>
                                            <div class="chat-user">
                                                <img class="chat-avatar" src="/Pub/admin/img/a1.jpg" alt="">
                                                <div class="chat-user-name">
                                            ...
                                            <div class="chat-user">
                                                ...
                                                <img class="chat-avatar" src="/Pub/admin/img/a2.jpg" alt="">
                                                <div class="chat-user-name">
                                            ...
                                            <div class="chat-user">
                                                <span class="pull-right label label-primary">在线</span>
                                                <img class="chat-avatar" src="/Pub/admin/img/a3.jpg" alt="">
                                                <div class="chat-user-name">
                                                    <a href="chat_view.html#">ZM敏姑娘	</a>
                                                </div>
                                            </div>
                                            <div class="chat-user">
                                                <img class="chat-avatar" src="/Pub/admin/img/a5.jpg" alt="">
                                                <div class="chat-user-name">
                                                    <a href="chat_view.html#">才越越</a>
                                                </div>
                                            </div>
                                            <div class="chat-user">
                                                <img class="chat-avatar" src="/Pub/admin/img/a6.jpg" alt="">
                                                <div class="chat-user-name">
