...
<head>
    ...
    <title>素材火www.sucaihuo.com - 日历</title>
    ...
    <link href="/Pub/admin/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="/Pub/admin/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="calendar.html">日历</a>
                        </li>
...
<script src="/Pub/admin/js/jquery-ui.custom.min.js"></script>

<!-- iCheck -->
<script src="/Pub/admin/js/plugins/iCheck/icheck.min.js"></script>

<!-- Full Calendar -->
<script src="/Pub/admin/js/plugins/fullcalendar/fullcalendar.min.js"></script>
