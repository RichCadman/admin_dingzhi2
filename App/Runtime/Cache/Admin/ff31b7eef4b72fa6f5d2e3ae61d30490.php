...
<head>
    ...
    <title>素材火www.sucaihuo.com - 写信</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="mail_compose.html">写信</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="mail_compose.html#"><i class="fa fa-bars"></i> </a>
...
<!-- SUMMERNOTE -->
<script src="/Pub/admin/js/plugins/summernote/summernote.min.js"></script>
<script src="/Pub/admin/js/plugins/summernote/summernote-zh-CN.js"></script>
<script>
