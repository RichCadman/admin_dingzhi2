...
<head>
    ...
    <link href="/Pub/admin/css/style.css?v=2.2.0" rel="stylesheet">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            ...
                            <div class="m-t-md">
                                ...
                                <div class="p-lg ">
                                    <a href="index_4.html">
                                        <img class="img-responsive img-shadow" src="/Pub/admin/img/index_4.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content text-center p-md">
                            ...
                            <div class="m-t-md">
                                ...
                                <div class="p-lg">
                                    <a href="index.html">
                                        <img class="img-responsive img-shadow" src="/Pub/admin/img/index.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script src="/Pub/admin/js/plugins/flot/jquery.flot.symbol.js"></script>
<script src="/Pub/admin/js/plugins/flot/curvedLines.js"></script>
