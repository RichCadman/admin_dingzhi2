...
<head>
    ...
    <title>素材火www.sucaihuo.com - jqGird</title>
    ...
    <link href="/Pub/admin/css/plugins/jQueryUI/jquery-ui-1.10.4.custom.min.css" rel="stylesheet">

    <!-- Data Tables -->
    <link href="/Pub/admin/css/plugins/jqgrid/ui.jqgrid.css" rel="stylesheet">
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="table_jqgrid.html#"><i class="fa fa-bars"></i> </a>
...
<!-- jqGrid -->
<script src="/Pub/admin/js/plugins/jqgrid/i18n/grid.locale-cn.js"></script>
<script src="/Pub/admin/js/plugins/jqgrid/jquery.jqGrid.min.js"></script>
