...
<head>
    ...
    <link href="/Pub/admin/css/plugins/chosen/chosen.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/switchery/switchery.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/nouslider/jquery.nouislider.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/datapicker/datepicker3.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet">
    <link href="/Pub/admin/css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet">

    <link href="/Pub/admin/css/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
...
<!-- Chosen -->
<script src="/Pub/admin/js/plugins/chosen/chosen.jquery.js"></script>

<!-- JSKnob -->
<script src="/Pub/admin/js/plugins/jsKnob/jquery.knob.js"></script>

<!-- Input Mask-->
<script src="/Pub/admin/js/plugins/jasny/jasny-bootstrap.min.js"></script>

<!-- Data picker -->
<script src="/Pub/admin/js/plugins/datapicker/bootstrap-datepicker.js"></script>

<!-- NouSlider -->
<script src="/Pub/admin/js/plugins/nouslider/jquery.nouislider.min.js"></script>

<!-- Switchery -->
<script src="/Pub/admin/js/plugins/switchery/switchery.js"></script>

<!-- IonRangeSlider -->
<script src="/Pub/admin/js/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>
...
<!-- COLORPICKER -->
<script src="/Pub/admin/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
