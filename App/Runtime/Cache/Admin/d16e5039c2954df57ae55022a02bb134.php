...
<head>
    ...
    <title>素材火www.sucaihuo.com - 文件管理器</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="file_manager.html">文件管理器</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="file_manager.html#"><i class="fa fa-bars"></i> </a>
                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="file_manager.html#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive" src="/Pub/admin/img/p1.jpg">
                                        </div>
                                        <div class="file-name">
                                            Italy street.jpg
                                            <br/>
                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="file_manager.html#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive" src="/Pub/admin/img/p2.jpg">
                                        </div>
                                        <div class="file-name">
                                            My feel.png
                                            <br/>
                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="file_manager.html#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive" src="/Pub/admin/img/p3.jpg">
                                        </div>
                                        <div class="file-name">
                                            Document_2014.doc
                                            <br/>
