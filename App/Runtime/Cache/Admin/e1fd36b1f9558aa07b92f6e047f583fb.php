...
<head>
    ...
    <link href="/Pub/admin/js/plugins/fancybox/jquery.fancybox.css" rel="stylesheet">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片1">
                                <img alt="image" src="/Pub/admin/img/p1.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片2">
                                <img alt="image" src="/Pub/admin/img/p2.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p3.jpg" title="图片3">
                                <img alt="image" src="/Pub/admin/img/p3.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片4">
                                <img alt="image" src="/Pub/admin/img/p4.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片5">
                                <img alt="image" src="/Pub/admin/img/p5.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p3.jpg" title="图片6">
                                <img alt="image" src="/Pub/admin/img/p6.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片7">
                                <img alt="image" src="/Pub/admin/img/p7.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片8">
                                <img alt="image" src="/Pub/admin/img/p8.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片9">
                                <img alt="image" src="/Pub/admin/img/p1.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片10">
                                <img alt="image" src="/Pub/admin/img/p2.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p3.jpg" title="图片11">
                                <img alt="image" src="/Pub/admin/img/p3.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片12">
                                <img alt="image" src="/Pub/admin/img/p4.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片13">
                                <img alt="image" src="/Pub/admin/img/p5.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p3.jpg" title="图片14">
                                <img alt="image" src="/Pub/admin/img/p6.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p1.jpg" title="图片15">
                                <img alt="image" src="/Pub/admin/img/p7.jpg" />
                            </a>
                            <a class="fancybox" href="/Pub/admin/img/p2.jpg" title="图片16">
                                <img alt="image" src="/Pub/admin/img/p8.jpg" />
                            </a>
...
<!-- Fancy box -->
<script src="/Pub/admin/js/plugins/fancybox/jquery.fancybox.js"></script>
