...
<head>
    ...
    <title>素材火www.sucaihuo.com - 百度Web Uploader</title>
    ...
    <link rel="stylesheet" type="text/css" href="/Pub/admin/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="/Pub/admin/css/demo/webuploader-demo.css">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="form_webuploader.html">百度WebUploader</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_webuploader.html#"><i class="fa fa-bars"></i> </a>
...
<script type="text/javascript">
    // 添加全局站点信息
    var BASE_URL = '/Pub/admin/js/plugins/webuploader';
</script>
<script src="/Pub/admin/js/plugins/webuploader/webuploader.min.js"></script>

<script src="/Pub/admin/js/demo/webuploader-demo.js"></script>
