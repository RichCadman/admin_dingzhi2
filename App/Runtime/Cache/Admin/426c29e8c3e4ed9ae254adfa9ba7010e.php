    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <div class="row  border-bottom white-bg dashboard-header">
            ...
            <div class="col-sm-3">
                ...
                <br>
                <br>
                <img src="/Pub/admin/img/qr_code.png" width="100%" style="max-width:264px;">
                <br>
            </div>
            <div class="col-sm-5">
                <h2>
                ...
                <p>
                    <a class="btn btn-success btn-outline"
                       href="http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes" target="_blank">
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <p>
                                        <img src="/Pub/admin/img/alipay_qr_code.png" width="100%" style="max-width:369px">
                                    </p>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">miaojianv1@sina.com
                                        / *玉恒</a>
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <div class="panel-group" id="version">
                                                ...
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">
                                                        <a data-toggle="collapse" data-parent="#version"
                                                           href="index.html#v22">v2.2</a><code class="pull-right">2015.05.01更新</code>
                                                    </h5>
                                                </div>
                                                ...
                                                <div id="v18" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            ...
                                                            <li>修复了WebUploader中的一些问题； <a href="form_webuploader.html"
                                                                                         title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                                        </ol>
                                                ...
                                                <div id="v17" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            ...
                                                            <li>修复Summernote编辑器中的一个严重错误； <a href="form_editors.html"
                                                                                            title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="v15" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            <li>增加了Bootstrap3表单构建器，表单设计更轻松； <a href="form_builder.html"
                                                                                               title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                                            <li>修改了webim的高度；
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="v14" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            <li>修复了百度ECharts图表显示不正确的问题； <a href="graph_echarts.html"
                                                                                           title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="v13" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            <li>加入阿里巴巴团队的字体图标库，字体图标可以自定义啦； <a href="iconfont.html"
                                                                                              title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                                            <li>新增头像裁剪上传组件FullAvatareditor； <a href="form_avatar.html"
                                                                                               title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                                            ...
                                                            <li class="text-danger"><b>增加web即时通讯功能，可以在系统内在线聊天了；</b> <a
                                                                    href="webim.html" title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="v12" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <ol>
                                                            <li>新增百度WebUploader拖动上传文件组件；<a href="form_webuploader.html"
                                                                                           title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
                                                            <li>新增国产优秀富文本编辑器插件Simditor；<a href="form_simditor.html"
                                                                                          title="去看看"><i
                                                                    class="fa fa-eye"></i></a>
                                                            </li>
