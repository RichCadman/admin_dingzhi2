...
<head>
    ...
    <title>素材火www.sucaihuo.com - 图片切换</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="carousel.html">图片切换</a>
                        </li>
                            ...
                            <div class="carousel slide" id="carousel1">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img alt="image" class="img-responsive" src="/Pub/admin/img/p_big3.jpg">
                                    </div>
                                    <div class="item">
                                        <img alt="image" class="img-responsive" src="/Pub/admin/img/p_big1.jpg">
                                    </div>
                                    <div class="item ">
                                        <img alt="image" class="img-responsive" src="/Pub/admin/img/p_big2.jpg">
                                    </div>
