...
<head>
    ...
    <title>素材火www.sucaihuo.com - 百度ECHarts</title>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="graph_echarts.html">百度ECharts</a>
                        </li>
...
<!-- ECharts -->
<script src="/Pub/admin/js/plugins/echarts/echarts-all.js"></script>
...
<!-- ECharts demo data -->
<script src="/Pub/admin/js/demo/echarts-demo.js"></script>
