...
<head>
    ...
    <title>素材火www.sucaihuo.com - 国产simditor富文本编辑器</title>
    ...
    <link rel="stylesheet" type="text/css" href="/Pub/admin/css/plugins/simditor/simditor.css" />
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_simditor.html#"><i class="fa fa-bars"></i> </a>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <strong>国产simditor富文本编辑器</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
...
<!-- simditor -->
<script type="text/javascript" src="/Pub/admin/js/plugins/simditor/module.js"></script>
<script type="text/javascript" src="/Pub/admin/js/plugins/simditor/uploader.js"></script>
<script type="text/javascript" src="/Pub/admin/js/plugins/simditor/hotkeys.js"></script>
<script type="text/javascript" src="/Pub/admin/js/plugins/simditor/simditor.js"></script>
<script type="text/javascript" src="http://www.zi-han.net/theme/hplus//Pub/admin/js/plugins/simditor/page-demo.js"></script>

<script>
    $(document).ready(function () {
        var editor = new Simditor({
            textarea: $('#editor'),
            defaultImage: '/Pub/admin/img/a9.jpg'
        });
    });
</script>
