...
<head>
    ...
    <title>素材火www.sucaihuo.com - 代码编辑器</title>
    ...
    <link href="/Pub/admin/css/plugins/codemirror/codemirror.css" rel="stylesheet">
    <link href="/Pub/admin/css/plugins/codemirror/ambiance.css" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="code_editor.html">代码编辑器</a>
                        </li>
                ...
                <div class="col-lg-6">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            ...
                            <textarea id="code2">// Code goes here
...
<!-- CodeMirror -->
<script src="/Pub/admin/js/plugins/codemirror/codemirror.js"></script>
<script src="/Pub/admin/js/plugins/codemirror/mode/javascript/javascript.js"></script>
