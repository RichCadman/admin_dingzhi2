...
<head>
    ...
    <title>素材火www.sucaihuo.com - 项目详情</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="project_detail.html">项目详情</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="project_detail.html#"><i class="fa fa-bars"></i> </a>
        ...
        <div class="row">
                                ...
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dd class="project-people">
                                            ...
                                            <a href="project_detail.html">
                                                <img alt="image" class="img-circle" src="/Pub/admin/img/a1.jpg">
                                            </a>
                                            <a href="project_detail.html">
            ...
            <div class="col-lg-3">
                <div class="wrapper wrapper-content project-manager">
                    <h4>项目描述</h4>
                    <img src="/Pub/admin/img/wenku_logo.png" class="img-responsive">
                    <p class="small">
