...
<head>
    ...
    <title>素材火www.sucaihuo.com - 树形视图</title>
    ...
    <link href="/Pub/admin/css/plugins/treeview/bootstrap-treeview.css" rel="stylesheet">
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="tree_view.html#"><i class="fa fa-bars"></i> </a>
...
<script src="/Pub/admin/js/plugins/treeview/bootstrap-treeview.js"></script>
<script src="/Pub/admin/js/demo/treeview-demo.js"></script>
