...
<head>
    ...
    <title>素材火www.sucaihuo.com - Morris.js图表</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="graph_morris.html">Morris.js</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="graph_morris.html#"><i class="fa fa-bars"></i> </a>
...
<!-- Morris -->
<script src="/Pub/admin/js/plugins/morris/raphael-2.1.0.min.js"></script>
<script src="/Pub/admin/js/plugins/morris/morris.js"></script>
...
<!-- Morris demo data-->
<script src="/Pub/admin/js/demo/morris-demo.js"></script>
