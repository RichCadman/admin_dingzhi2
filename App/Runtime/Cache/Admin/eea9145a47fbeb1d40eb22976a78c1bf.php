                        ...
                        <div class="ibox-content">
                            ...
                            <div class="m-t m-b">
                                ...
                                <div id="userAlbums" style="display:none">
                                    <a href="/Pub/admin/img/a1.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a1.jpg" alt="示例图片1" />
                                    </a>
                                    <a href="/Pub/admin/img/a2.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a2.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a3.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a3.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a4.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a4.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a5.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a5.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a6.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a6.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a7.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a7.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a8.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a8.jpg" alt="示例图片2" />
                                    </a>
                                    <a href="/Pub/admin/img/a9.jpg" class="fancybox" title="选取该照片">
                                        <img src="/Pub/admin/img/a9.jpg" alt="示例图片2" />
                                    </a>>
                                </div>
                            </div>
...
<!-- fullavatareditor -->
<script type="text/javascript" src="/Pub/admin//plugins/fullavatareditor/scripts/swfobject.js"></script>
<script type="text/javascript" src="/Pub/admin//plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
<script type="text/javascript" src="/Pub/admin//plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
<script type="text/javascript" src="/Pub/admin//plugins/fullavatareditor/scripts/test.js"></script>
