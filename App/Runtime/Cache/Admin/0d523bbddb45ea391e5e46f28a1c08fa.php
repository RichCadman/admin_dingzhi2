...
<head>
    ...
    <title>素材火www.sucaihuo.com - 项目</title>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="projects.html">项目</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="projects.html#"><i class="fa fa-bars"></i> </a>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a3.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a1.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a2.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a4.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a5.jpg"></a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a7.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a6.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="/Pub/admin/img/a3.jpg"></a>
                                        </td>
                                        <td class="project-actions">
                                            <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
...
<script src="/Pub/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script><script src="/Pub/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
