            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="tree_view_v2.html">树形视图</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="tree_view_v2.html#"><i class="fa fa-bars"></i> </a>
...
<script src="/Pub/admin/js/plugins/jsTree/jstree.min.js"></script>
