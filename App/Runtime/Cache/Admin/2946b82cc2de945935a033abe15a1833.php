...
<head>
    ...
    <title>素材火www.sucaihuo.com - 富文本编辑器</title>
    ...
    <link href="/Pub/admin/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="/Pub/admin/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="form_editors.html">富文本编辑器</a>
                        </li>
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_editors.html#"><i class="fa fa-bars"></i> </a>
...
<!-- Mainly scripts -->
<script src="/Pub/admin/img/jquery-2.1.1.min.js"></script>
<script src="/Pub/admin/img/bootstrap.min.js"></script>
<script src="/Pub/admin/img/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/Pub/admin/img/plugins/slimscroll/jquery.slimscroll.min.js"></script>

<!-- Custom and plugin javascript -->
<script src="/Pub/admin/img/hplus.js"></script>
<script src="/Pub/admin/img/plugins/pace/pace.min.js"></script>

<!-- SUMMERNOTE -->
<script src="/Pub/admin/img/plugins/summernote/summernote.min.js"></script>
<script src="/Pub/admin/img/plugins/summernote/summernote-zh-CN.js"></script>
